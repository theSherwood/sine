...
goog.define = function(a, b) {
  COMPILED || (goog.global.CLOSURE_UNCOMPILED_DEFINES && Object.prototype.hasOwnProperty.call(goog.global.CLOSURE_UNCOMPILED_DEFINES, a) ? b = goog.global.CLOSURE_UNCOMPILED_DEFINES[a] : goog.global.CLOSURE_DEFINES && Object.prototype.hasOwnProperty.call(goog.global.CLOSURE_DEFINES, a) && (b = goog.global.CLOSURE_DEFINES[a]));
...
goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = {loadFlags:{}, nameToPath:{}, requires:{}, visited:{}, written:{}, deferred:{}}, goog.inHtmlDocument_ = function() {
  ...
  if (goog.inHtmlDocument_()) {
    ...
    void 0 === b ? goog.IS_OLD_IE_ ? (b = " onreadystatechange\x3d'goog.onScriptLoad_(this, " + ++goog.lastNonModuleScriptIndex_ + ")' ", c.write('\x3cscript type\x3d"text/javascript" src\x3d"' + a + '"' + b + "\x3e\x3c/script\x3e")) : goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? goog.appendScriptSrcNode_(a) : goog.writeScriptSrcNode_(a) : c.write('\x3cscript type\x3d"text/javascript"\x3e' + b + "\x3c/script\x3e");
    return !0;
  }
  return !1;
...
var module$src$sine$hyper = {}, EMPTY_ARR$$module$src$sine$hyper = [], api$$module$src$sine$hyper = {}, h$$module$src$sine$hyper = function(a) {
  ...
  var d, e = function(a) {
    if (null != a) {
      if ("string" === typeof a) {
        d ? api$$module$src$sine$hyper.add(d, a) : d = api$$module$src$sine$hyper.s ? document.createElementNS("http://www.w3.org/2000/svg", a) : document.createElement(a);
      } else {
        if (Array.isArray(a)) {
          d || (d = document.createDocumentFragment()), a.forEach(e);
        } else {
          if (a instanceof Node) {
            d ? api$$module$src$sine$hyper.add(d, a) : d = a;
          } else {
            if ("object" === typeof a) {
              api$$module$src$sine$hyper.property(d, a, null, api$$module$src$sine$hyper.s);
            } else {
              if ("function" === typeof a) {
                if (d) {
                  var c = api$$module$src$sine$hyper.add(d, "");
                  api$$module$src$sine$hyper.insert(d, a, c);
                } else {
                  d = a.apply(null, b.splice(1));
                }
              } else {
                api$$module$src$sine$hyper.add(d, "" + a);
              }
            }
          }
        }
  ...
  b.forEach(e);
  return d;
}, castNode$$module$src$sine$hyper = function(a) {
  return "string" === typeof a ? document.createTextNode(a) : a instanceof Node ? a : api$$module$src$sine$hyper.h(EMPTY_ARR$$module$src$sine$hyper, a);
}, frag$$module$src$sine$hyper = function(a) {
  var b = a.childNodes;
  if (b && 11 === a.nodeType) {
    return 2 > b.length ? b[0] : {_startMark:api$$module$src$sine$hyper.add(a, "", b[0])};
  }
}, add$$module$src$sine$hyper = function(a, b, c) {
  b = castNode$$module$src$sine$hyper(b);
  var d = frag$$module$src$sine$hyper(b) || b;
  a.insertBefore(b, c && c.parentNode && c);
  return d;
}, insert$$module$src$sine$hyper = function(a, b, c, d, e) {
  a = c && c.parentNode || a;
  e = e || d instanceof Node && d;
  b !== d && (d && "string" !== typeof d || !("string" === typeof b || "number" === typeof b && (b += "")) ? "function" === typeof b ? api$$module$src$sine$hyper.subscribe(function() {
    d = api$$module$src$sine$hyper.insert(a, b.call({el:a, endMark:c}), c, d, e);
  }) : (c ? d && (e || (e = d._startMark && d._startMark.nextSibling || c.previousSibling), api$$module$src$sine$hyper.rm(a, e, c)) : a.textContent = "", d = null, b && !0 !== b && (d = api$$module$src$sine$hyper.add(a, b, c))) : (null != d && a.firstChild ? c ? (c.previousSibling || a.lastChild).data = b : a.firstChild.data = b : c ? api$$module$src$sine$hyper.add(a, b, c) : a.textContent = b, d = b));
  return d;
};
function eventProxy$$module$src$sine$hyper(a) {
  return this._listeners[a.type](a);
}
var handleEvent$$module$src$sine$hyper = function(a, b, c) {
  b = b.slice(2).toLowerCase();
  c ? a.addEventListener(b, eventProxy$$module$src$sine$hyper) : a.removeEventListener(b, eventProxy$$module$src$sine$hyper);
  (a._listeners || (a._listeners = {}))[b] = c;
}, property$$module$src$sine$hyper = function(a, b, c, d, e) {
  if (null != b) {
    if (!c || "attrs" === c && (d = !0)) {
      for (c in b) {
        api$$module$src$sine$hyper.property(a, b[c], c, d, e);
      }
    } else {
      "o" !== c[0] || "n" !== c[1] || b.$o ? "function" === typeof b ? api$$module$src$sine$hyper.subscribe(function() {
        api$$module$src$sine$hyper.property(a, b.call({el:a, name:c}), c, d, e);
      }) : e ? a.style.setProperty(c, b) : d || "data-" === c.slice(0, 5) || "aria-" === c.slice(0, 5) ? a.setAttribute(c, b) : "style" === c ? "string" === typeof b ? a.style.cssText = b : api$$module$src$sine$hyper.property(a, b, null, d, !0) : ("class" === c && (c += "Name"), a[c] = b) : handleEvent$$module$src$sine$hyper(a, c, b);
    }
  }
}, removeNodes$$module$src$sine$hyper = function(a, b, c) {
  for (;b && b !== c;) {
    var d = b.nextSibling;
...
api$$module$src$sine$hyper.insert = insert$$module$src$sine$hyper;
api$$module$src$sine$hyper.property = property$$module$src$sine$hyper;
api$$module$src$sine$hyper.add = add$$module$src$sine$hyper;
api$$module$src$sine$hyper.rm = removeNodes$$module$src$sine$hyper;
api$$module$src$sine$hyper.h = h$$module$src$sine$hyper;
module$src$sine$hyper.api = api$$module$src$sine$hyper;
var module$src$sine$observable = {}, EMPTY_ARR$$module$src$sine$observable = [], tracking$$module$src$sine$observable, queue$$module$src$sine$observable;
function getChildrenDeep$$module$src$sine$observable(a) {
  return a.reduce(function(a, c) {
    return a.concat(c, getChildrenDeep$$module$src$sine$observable(c._children));
  }, []);
}
function isListening$$module$src$sine$observable() {
  return !!tracking$$module$src$sine$observable;
}
function root$$module$src$sine$observable(a) {
  var b = tracking$$module$src$sine$observable, c = function() {
  };
  tracking$$module$src$sine$observable = c;
  resetUpdate$$module$src$sine$observable(c);
  a = a(function() {
    _unsubscribe$$module$src$sine$observable(c);
    tracking$$module$src$sine$observable = void 0;
  });
  tracking$$module$src$sine$observable = b;
  return a;
}
function sample$$module$src$sine$observable(a) {
  var b = tracking$$module$src$sine$observable;
  tracking$$module$src$sine$observable = void 0;
  a = a();
  tracking$$module$src$sine$observable = b;
  return a;
}
function transaction$$module$src$sine$observable(a) {
  var b = queue$$module$src$sine$observable;
  queue$$module$src$sine$observable = [];
  a = a();
  var c = queue$$module$src$sine$observable;
  queue$$module$src$sine$observable = b;
  c.forEach(function(a) {
    if (a._pending !== EMPTY_ARR$$module$src$sine$observable) {
      var b = a._pending;
      a._pending = EMPTY_ARR$$module$src$sine$observable;
      a(b);
    }
  });
  return a;
}
function observable$$module$src$sine$observable(a) {
  function b(c) {
    if (0 === arguments.length) {
      return tracking$$module$src$sine$observable && !b._observers.has(tracking$$module$src$sine$observable) && (b._observers.add(tracking$$module$src$sine$observable), tracking$$module$src$sine$observable._observables.push(b)), a;
    }
    if (queue$$module$src$sine$observable) {
      return b._pending === EMPTY_ARR$$module$src$sine$observable && queue$$module$src$sine$observable.push(b), b._pending = c;
    }
    a = c;
    var d = tracking$$module$src$sine$observable;
    tracking$$module$src$sine$observable = void 0;
    b._runObservers = new Set(b._observers);
    b._runObservers.forEach(function(a) {
      return a._fresh = !1;
    });
    b._runObservers.forEach(function(a) {
      a._fresh || a();
    });
    tracking$$module$src$sine$observable = d;
    return a;
  }
  b.$o = !0;
  b._observers = new Set;
  b._pending = EMPTY_ARR$$module$src$sine$observable;
  return b;
}
function computed$$module$src$sine$observable(a, b) {
  function c() {
    var d = tracking$$module$src$sine$observable;
    tracking$$module$src$sine$observable && tracking$$module$src$sine$observable._children.push(c);
    var f = c._children;
    _unsubscribe$$module$src$sine$observable(c);
    c._fresh = !0;
    tracking$$module$src$sine$observable = c;
    ...
    f.forEach(function(a) {
      -1 === c._children.indexOf(a) && (a._fresh = !0);
    });
    getChildrenDeep$$module$src$sine$observable(c._children).forEach(removeFreshChildren$$module$src$sine$observable);
    tracking$$module$src$sine$observable = d;
    return b;
  }
  function d() {
    c._fresh ? c._observables.forEach(function(a) {
      return a();
    }) : b = c();
    return b;
  }
...
function removeFreshChildren$$module$src$sine$observable(a) {
  a._fresh && a._observables.forEach(function(b) {
    b._runObservers && b._runObservers.delete(a);
  });
}
function cleanup$$module$src$sine$observable(a) {
  tracking$$module$src$sine$observable && tracking$$module$src$sine$observable._cleanups.push(a);
  return a;
}
function subscribe$$module$src$sine$observable(a) {
  computed$$module$src$sine$observable(a);
  return function() {
...
function _unsubscribe$$module$src$sine$observable(a) {
  a._children.forEach(_unsubscribe$$module$src$sine$observable);
  a._observables.forEach(function(b) {
    b._observers.delete(a);
    b._runObservers && b._runObservers.delete(a);
  });
  a._cleanups.forEach(function(a) {
    return a();
  });
  resetUpdate$$module$src$sine$observable(a);
}
function resetUpdate$$module$src$sine$observable(a) {
  a._observables = [];
  a._children = [];
  a._cleanups = [];
}
module$src$sine$observable.isListening = isListening$$module$src$sine$observable;
module$src$sine$observable.root = root$$module$src$sine$observable;
module$src$sine$observable.sample = sample$$module$src$sine$observable;
module$src$sine$observable.transaction = transaction$$module$src$sine$observable;
...
var module$src$sine$api = {};
Object.assign(module$src$sine$hyper.api, module$src$sine$observable);
var $jscomp$destructuring$var1 = module$src$sine$hyper.api, h$$module$src$sine$api = module$src$sine$hyper.api.h;
module$src$sine$api.observable = module$src$sine$observable.observable;
module$src$sine$api.o = module$src$sine$observable.o;
module$src$sine$api.subscribe = module$src$sine$observable.subscribe;
module$src$sine$api.computed = module$src$sine$observable.computed;
module$src$sine$api.sample = module$src$sine$observable.sample;
module$src$sine$api.on = module$src$sine$observable.on;
module$src$sine$api.root = module$src$sine$observable.root;
module$src$sine$api.transaction = module$src$sine$observable.transaction;
module$src$sine$api.api = module$src$sine$hyper.api;
module$src$sine$api.h = h$$module$src$sine$api;
goog.string = {};
...
goog.string.compareVersions = function(a, b) {
  ...
  for (var d = Math.max(a.length, b.length), e = 0;0 == c && e < d;e++) {
    var f = a[e] || "", g = b[e] || "", h = /(\d*)(\D*)/g, k = /(\d*)(\D*)/g;
    do {
      var l = h.exec(f) || ["", "", ""], m = k.exec(g) || ["", "", ""];
...
cljs.core.into_array.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  ...
  var c = [];
  return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3 ? cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(a, c, b) : cljs.core.reduce.call(null, a, c, b);
};
...
cljs.core.Var.prototype.cljs$core$IEquiv$_equiv$arity$2 = function(a, b) {
  return b instanceof cljs.core.Var ? (a = this.sym, b = b.sym, cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2 ? cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(a, b) : cljs.core._EQ_.call(null, a, b)) : !1;
};
...
cljs.core.nthrest = function(a, b) {
  for (;;) {
    if (0 < b && cljs.core.seq(a)) {
      --b, a = cljs.core.rest(a);
    } else {
      return a;
    }
  }
...
cljs.core.sort.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  return cljs.core.seq(b) ? (b = cljs.core.to_array.cljs$core$IFn$_invoke$arity$1 ? cljs.core.to_array.cljs$core$IFn$_invoke$arity$1(b) : cljs.core.to_array.call(null, b), a = cljs.core.fn__GT_comparator(a), goog.array.stableSort(b, a), cljs.core.seq(b)) : cljs.core.List.EMPTY;
};
...
cljs.core.seq_reduce.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  ...
  return c ? (b = cljs.core.first(c), c = cljs.core.next(c), cljs.core.reduce.cljs$core$IFn$_invoke$arity$3 ? cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(a, b, c) : cljs.core.reduce.call(null, a, b, c)) : a.cljs$core$IFn$_invoke$arity$0 ? a.cljs$core$IFn$_invoke$arity$0() : a.call(null);
};
...
cljs.core.extend_object_BANG_ = function(a, b) {
  ...
  for (var c = null, d = 0, e = 0;;) {
    if (e < d) {
      var f = c.cljs$core$IIndexed$_nth$arity$2(null, e), g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(f, 0, null), f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(f, 1, null), g = cljs.core.name.cljs$core$IFn$_invoke$arity$1 ? cljs.core.name.cljs$core$IFn$_invoke$arity$1(g) : cljs.core.name.call(null, g);
      a[g] = f;
      e += 1;
    } else {
      if (b = cljs.core.seq(b)) {
        cljs.core.chunked_seq_QMARK_(b) ? (d = cljs.core.chunk_first.cljs$core$IFn$_invoke$arity$1 ? cljs.core.chunk_first.cljs$core$IFn$_invoke$arity$1(b) : cljs.core.chunk_first.call(null, b), b = cljs.core.chunk_rest.cljs$core$IFn$_invoke$arity$1 ? cljs.core.chunk_rest.cljs$core$IFn$_invoke$arity$1(b) : cljs.core.chunk_rest.call(null, b), c = d, d = cljs.core.count(d)) : (d = cljs.core.first(b), c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(d, 0, null), d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(d, 
        1, null), c = cljs.core.name.cljs$core$IFn$_invoke$arity$1 ? cljs.core.name.cljs$core$IFn$_invoke$arity$1(c) : cljs.core.name.call(null, c), a[c] = d, b = cljs.core.next(b), c = null, d = 0), e = 0;
      } else {
        break;
      }
    }
...
cljs.core.keyword.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  a = a instanceof cljs.core.Keyword ? cljs.core.name.cljs$core$IFn$_invoke$arity$1 ? cljs.core.name.cljs$core$IFn$_invoke$arity$1(a) : cljs.core.name.call(null, a) : a instanceof cljs.core.Symbol ? cljs.core.name.cljs$core$IFn$_invoke$arity$1 ? cljs.core.name.cljs$core$IFn$_invoke$arity$1(a) : cljs.core.name.call(null, a) : a;
  b = b instanceof cljs.core.Keyword ? cljs.core.name.cljs$core$IFn$_invoke$arity$1 ? cljs.core.name.cljs$core$IFn$_invoke$arity$1(b) : cljs.core.name.call(null, b) : b instanceof cljs.core.Symbol ? cljs.core.name.cljs$core$IFn$_invoke$arity$1 ? cljs.core.name.cljs$core$IFn$_invoke$arity$1(b) : cljs.core.name.call(null, b) : b;
  return new cljs.core.Keyword(a, b, [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.truth_(a) ? [cljs.core.str.cljs$core$IFn$_invoke$arity$1(a), cljs.core.str.cljs$core$IFn$_invoke$arity$1("/")].join("") : null), cljs.core.str.cljs$core$IFn$_invoke$arity$1(b)].join(""), null);
};
...
cljs.core.LazyTransformer.createMulti = function(a, b) {
  ...
  for (var d = null, e = 0, f = 0;;) {
    if (f < e) {
      ...
      c.push(cljs.core.iter(g));
      f += 1;
    } else {
      if (b = cljs.core.seq(b)) {
        d = b, cljs.core.chunked_seq_QMARK_(d) ? (b = cljs.core.chunk_first(d), f = cljs.core.chunk_rest(d), d = b, e = cljs.core.count(b), b = f) : (b = cljs.core.first(d), c.push(cljs.core.iter(b)), b = cljs.core.next(d), d = null, e = 0), f = 0;
      } else {
        break;
      }
    }
...
cljs.core.Subvec.prototype.cljs$core$ICollection$_conj$arity$2 = function(a, b) {
  a = this.meta;
  b = cljs.core._assoc_n(this.v, this.end, b);
      ...
      return cljs.core.tail_off(this) <= b ? d.tail[b & 31] = c : (a = function(a) {
        return function g(a, e) {
          ...
          if (0 === a) {
            ...
            var h = b >>> a & 31;
            cljs.core.pv_aset(e, h, g(a - 5, cljs.core.pv_aget(e, h)));
          }
          return e;
        };
...
cljs.core.PersistentArrayMap.prototype.cljs$core$IFind$_find$arity$2 = function(a, b) {
  ...
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [this.arr[a], cljs.core.get.cljs$core$IFn$_invoke$arity$2(this, b)], null);
};
...
cljs.core.PersistentArrayMap.prototype.cljs$core$IMap$_dissoc$arity$2 = function(a, b) {
  if (0 <= cljs.core.array_map_index_of(this, b)) {
    ...
    for (var c = Array(c), d = 0, e = 0;;) {
      if (d >= a) {
        return new cljs.core.PersistentArrayMap(this.meta, this.cnt - 1, c, null);
      }
      cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(b, this.arr[d]) || (c[e] = this.arr[d], c[e + 1] = this.arr[d + 1], e += 2);
      d += 2;
    }
  } else {
    return this;
...
cljs.core.TransientArrayMap.prototype.cljs$core$ITransientCollection$_conj_BANG_$arity$2 = function(a, b) {
  if (cljs.core.truth_(this.editable_QMARK_)) {
    ...
    for (b = this;;) {
      var c = cljs.core.first(a);
      if (cljs.core.truth_(c)) {
        a = cljs.core.next(a), b = b.cljs$core$ITransientAssociative$_assoc_BANG_$arity$3(null, cljs.core.key.cljs$core$IFn$_invoke$arity$1 ? cljs.core.key.cljs$core$IFn$_invoke$arity$1(c) : cljs.core.key.call(null, c), cljs.core.val.cljs$core$IFn$_invoke$arity$1 ? cljs.core.val.cljs$core$IFn$_invoke$arity$1(c) : cljs.core.val.call(null, c));
      } else {
        return b;
      }
    }
...
cljs.core.ArrayNode.prototype.kv_reduce = function(a, b) {
  for (var c = this.arr.length, d = 0;;) {
    if (d < c) {
      var e = this.arr[d];
      if (null != e && (b = e.kv_reduce(a, b), cljs.core.reduced_QMARK_(b))) {
...
cljs.core.PersistentHashMap.fromArray = function(a, b) {
  ...
  for (var c = 0, d = cljs.core.transient$(cljs.core.PersistentHashMap.EMPTY);;) {
    if (c < b) {
      var e = c + 2, d = cljs.core._assoc_BANG_(d, a[c], a[c + 1]), c = e;
    } else {
...
cljs.core.PersistentHashSet.fromArray = function(a, b) {
  ...
  if (c <= cljs.core.PersistentArrayMap.HASHMAP_THRESHOLD) {
    ...
    for (var d = cljs.core.transient$(cljs.core.PersistentArrayMap.EMPTY);;) {
      if (b < c) {
        var e = b + 1, d = cljs.core._assoc_BANG_(d, a[b], null);
        b = e;
      } else {
  ...
  return function c(a, e) {
    return new cljs.core.LazySeq(null, function() {
      return function(a, d) {
        for (;;) {
          var e = a;
          a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(e, 0, null);
          if (e = cljs.core.seq(e)) {
            if (cljs.core.contains_QMARK_(d, a)) {
              a = cljs.core.rest(e);
            } else {
              return cljs.core.cons(a, c(cljs.core.rest(e), cljs.core.conj.cljs$core$IFn$_invoke$arity$2(d, a)));
            }
          } else {
            return null;
          }
...
cljs.core.re_seq = function(a, b) {
  var c = cljs.core.re_find(a, b), d = b.search(a), e = cljs.core.coll_QMARK_(c) ? cljs.core.first(c) : c;
  b = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(b, d + cljs.core.count(e));
    ...
    return c = function(a, b) {
      for (a = "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(a);;) {
        if (cljs.core.count(a) < b) {
          a = [cljs.core.str.cljs$core$IFn$_invoke$arity$1("0"), cljs.core.str.cljs$core$IFn$_invoke$arity$1(a)].join("");
        } else {
          return a;
        }
      }
...
cljs.core.MultiFn.prototype.cljs$core$IMultiFn$_get_method$arity$2 = function(a, b) {
  ...
  a = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(this.method_cache) : cljs.core.deref.call(null, this.method_cache)).call(null, b);
  if (cljs.core.truth_(a)) {
    return a;
  }
  b = cljs.core.find_and_cache_best_method(this.name, b, this.hierarchy, this.method_table, this.prefer_table, this.method_cache, this.cached_hierarchy);
  return cljs.core.truth_(b) ? b : (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(this.method_table) : cljs.core.deref.call(null, this.method_table)).call(null, this.default_dispatch_val);
};
...
var sine = {core:{}};
sine.core.normalize_arguments = function(a, b) {
  var c = cljs.core.second.call(null, a), d = cljs.core.map_QMARK_.call(null, c) ? 2 : 1, c = cljs.core.clj__GT_js.call(null, cljs.core._EQ_.call(null, d, 2) ? c : cljs.core.PersistentArrayMap.EMPTY);
  a = cljs.core.clj__GT_js.call(null, cljs.core.mapv.call(null, b, cljs.core.subvec.call(null, a, d)));
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c, a], null);
};
sine.core.create_node_builder = function(a) {
  return function() {
    var b = function(b, e) {
      if (0 < cljs.core.count.call(null, e)) {
        var d = new DocumentFragment;
        console.log("here", e);
        d.append(c.call(null, b));
        b = cljs.core.count.call(null, e);
        for (var g = 0;;) {
          if (g < b) {
        ...
        return cljs.core.vector_QMARK_.call(null, b) ? (e = cljs.core.first.call(null, b), cljs.core.fn_QMARK_.call(null, e) || e instanceof cljs.core.Keyword || "string" === typeof e ? (b = sine.core.normalize_arguments.call(null, b, c), d = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null), a.call(null, cljs.core.fn_QMARK_.call(null, e) ? e : cljs.core.name.call(null, e), d, cljs.core.into.call(null, b))) : cljs.core.apply.call(null, a, cljs.core.mapv.call(null, function(a) {
          return function(a) {
...
sine.core.render = function(a, b) {
  return document.querySelector(a).append(b);
};
sine.core.html = sine.core.create_node_builder.call(null, module$src$sine$api.h);
sine.core.counter = function() {
  var a = module$src$sine$api.o.call(null, 0);
  return sine.core.html.call(null, new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "div", "div", 1057191632), "Count: ", a, " ", new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "button", "button", 1456579943), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "onclick", "onclick", 1297553739), function(a) {
    return function() {
      return a.call(null, a.call(null) + 1);
    };
  }(a)], null), "Inc"], null)], null));
};
sine.core.app = function() {
  return sine.core.html.call(null, new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "div", "div", 1057191632), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "h1", "h1", -1896887462), "Welcome to the app!"], null), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sine.core.counter], null)], null));
};
sine.core.render.call(null, "#app", sine.core.app.call(null));
sine.atom = {};
sine.atom.empty_array = [];
sine.atom.listening_QMARK_ = function() {
  return sine.atom.tracking;
};
sine.atom.reset_update = function(a) {
  a.observables = [];
  a.children = [];
  return a.cleanups = [];
};
sine.atom._unsubscribe = function(a) {
  for (var b = cljs.core.count.call(null, a.children), c = 0;;) {
    if (c < b) {
      sine.atom._unsubscribe.call(null, cljs.core.nth.call(null, a.children, c)), c += 1;
    } else {
      break;
    }
  }
  b = cljs.core.count.call(null, a.observables);
  for (c = 0;;) {
    if (c < b) {
      var d = cljs.core.nth.call(null, a.observables, c);
      cljs.core.disj.call(null, d.observers, a);
      0 !== cljs.core.count.call(null, d.run_observers) ? cljs.core.disj.call(null, d.run_observers, a) : cljs.core.List.EMPTY;
      c += 1;
    } else {
      break;
    }
  }
  b = cljs.core.count.call(null, a.cleanups);
  for (c = 0;;) {
    if (c < b) {
      cljs.core.nth.call(null, a.cleanups, c).call(null), c += 1;
    } else {
      break;
    }
  }
  return sine.atom.reset_update.call(null, a);
};
sine.atom.unsubscribe = function(a) {
  return sine.atom._unsubscribe.call(null, a.update);
};
sine.atom.cleanup = function(a) {
  cljs.core.truth_(sine.atom.tracking) ? sine.atom.tracking.cleanups.push(a) : cljs.core.List.EMPTY;
  return a;
};
sine.atom.root = function(a) {
  var b = sine.atom.tracking, c = function(a) {
    return function() {
      return cljs.core.List.EMPTY;
    };
  }(b);
  sine.atom.tracking = c;
  sine.atom.reset_update.call(null, c);
  a = a.call(null, function(a, b) {
    return function() {
      sine.atom._unsubscribe.call(null, b.call(null));
      return sine.atom.tracking = null;
    };
  }(b, c));
  sine.atom.tracking = b;
  return a;
};
sine.atom.sample = function(a) {
  var b = sine.atom.tracking;
  sine.atom.tracking = null;
  a = a.call(null);
  sine.atom.tracking = b;
  return a;
};
sine.atom.remove_fresh_children = function(a) {
  if (cljs.core.truth_(a.fresh)) {
    for (var b = cljs.core.count.call(null, a.observables), c = 0;;) {
      if (c < b) {
        var d = cljs.core.nth.call(null, a.observables, c);
        0 !== cljs.core.count.call(null, d.run_observers) ? cljs.core.disj.call(null, d.run_observers, a) : cljs.core.List.EMPTY;
        c += 1;
